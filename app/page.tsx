      ...
      <section className="relative py-28 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <blockquote className="font-display text-2xl md:text-3xl italic text-warm-white mb-6 leading-relaxed">
            Our commitment doesn't end at graduation. We are developing transitional support for young men ages 18–24 because lasting change takes time, relationship, and community.
          </blockquote>
