...
export default function HomePage() {
  return (
    <>
      ...
      {/* Feature Section + Quote — gradient from offwhite into navy */}
      <section className="px-6" style={{ background: "linear-gradient(to bottom, var(--offwhite) 0%, var(--offwhite) 40%, var(--navy) 72%, var(--navy) 100%)" }}>
        {/* Two-column feature */}
        <div className="max-w-7xl mx-auto pt-20 pb-24 grid md:grid-cols-2 gap-12 items-center">
          <div>
        ...
        {/* Quote — sits in the navy portion of the gradient */}
        <div className="max-w-4xl mx-auto pb-24 text-center">
